                ...
                steps {
                    withCredentials([[
                        ...
                        script {
                            ...
                            docker.withRegistry("https://$image_url", "ecr:$region:jenkins") {
                                image.push('latest')
                ...
                steps {
                    withCredentials([[
                        ...
                        script {
                            ...
                            sh "kubectl -n microservices set image deployments/$POM_ARTIFACTID $POM_ARTIFACTID=$image_url:${getCommitSha().substring(0, 7)}"
                        }
                    }
                }
            }
